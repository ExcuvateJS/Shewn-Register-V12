...
.setColor('000001')
.setDescription(`${member} üyesi Başarıyla <@&${config.roles.erkek1}> Olarak  Kayıt Edildi ${emoji.shewn}
...
message.channel.send(shewn).then(shewn => shewn.delete({ timeout : 10000 }))
message.react(emoji.onayemoji)
client.channels.cache.get(config.giriş.generalchat).send(`${member} **Adlı üye** \`Erkek\` **olarak aramıza katıldı hadi ona hoşgeldin diyelim.**`)
